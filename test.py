...
def cal_miou(test_dir,result_dir):                      # ---图像测试集路径和标签路径----#
    ...
    net = UNet(n_classes = num_classes)                                         # --------加载网络-------#
...
if __name__ == '__main__':
    ...
    cal_miou(test_dir = "/home/lijiangtao/Desktop/T/mseg/datasets/model_test_data",         #测试数据集
             result_dir="/home/lijiangtao/Desktop/T/mseg/results/Unet/3-1-13-45")